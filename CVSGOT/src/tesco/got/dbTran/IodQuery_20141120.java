...
public class IodQuery_20141120 {
     ...
     * @param item_code
     */
    public IodQuery_20141120(String store_code, String barcode) {
...
/* Hub Spoke 관련 추가 - End */                                        
            ...
            if(order_type.equalsIgnoreCase("F")){
                ...
                sql.append("       FROM SUPS_ATTR WHERE SUPPLIER_NO = AA.SUPPLIER_NO  AND STORE_NO = TO_CHAR(AA.STORE_NO) ) AS IPGODAYS ");
